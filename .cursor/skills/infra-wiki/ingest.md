...
6. 按 [index-log.md](index-log.md) 更新被改目录的 `index.md`；新分组条目才改根 `wiki/index.md`。
7. 按 [index-log.md](index-log.md) 在 `wiki/log.md` 当日节顶部追加一条（一篇一链，`**Creation**:` / `**Update**:`，ASCII 冒号）。
